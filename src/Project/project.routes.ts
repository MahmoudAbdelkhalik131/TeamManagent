...
projectRouter.route("/")
.get(auth.verifyToken,projectServices.getAll)
projectRouter.route('/:id')
.get(auth.verifyToken,projectValidation.getone,projectServices.getOne)
.put(auth.allowedRoles(['admin']),projectValidation.updateOne,projectServices.updateOne)
.delete(auth.allowedRoles(['admin']),projectValidation.deleteOne,projectServices.deleteOne)
